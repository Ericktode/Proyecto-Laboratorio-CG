...
//************** Alumno (s): *********************************//
//*************	TORRES DIAZ ERICK						******//
//*************	PROYECTO FINAL LABORATORIO DE CG		******//
//************************************************************//
//************************************************************//
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	ParedBlan.LoadTGA("ParedBlan.tga");
	ParedBlan.BuildGLTexture();
	ParedBlan.ReleaseImage();
	...
	Piso.LoadTGA("grass.tga");
	Piso.BuildGLTexture();
	Piso.ReleaseImage();

	Alfombra.LoadTGA("alf.tga");
	Alfombra.BuildGLTexture();
	Alfombra.ReleaseImage();

	Piso1.LoadTGA("Piso3.tga");
	Piso1.BuildGLTexture();
	Piso1.ReleaseImage();

	Barra.LoadTGA("barra.tga");
	...
	Pret.LoadTGA("pretil.tga");
	Pret.BuildGLTexture();
	Pret.ReleaseImage();

	Marco.LoadTGA("marconegro.tga");
	Marco.BuildGLTexture();
	Marco.ReleaseImage();

	Madera.LoadTGA("repisa1.tga");
	Madera.BuildGLTexture();
	Madera.ReleaseImage();

	Cuero.LoadTGA("Cuero.tga");
	Cuero.BuildGLTexture();
	Cuero.ReleaseImage();

	Cuero1.LoadTGA("Cuero1.tga");
	Cuero1.BuildGLTexture();
	Cuero1.ReleaseImage();
	...
	pantallatv.LoadTGA("Pantalla.tga");
...
void sillon1()
{
	glPushMatrix();
		glPushMatrix();//respaldo
			...
			figura.prisma(1.0, 1.0, 1.0, Cuero.GLindex);
		glPopMatrix();
		glPushMatrix();//codera derecha
			glTranslatef(4.5, -1.0, 2.0);
			glPushMatrix();
				glScalef(1.0, 5.0, 3.0);
				figura.prisma(1.0, 1.0, 1.0, Cuero1.GLindex);
			glPopMatrix();
		glPopMatrix();
	...
	glPushMatrix();
		...
		glPushMatrix();//Tapa frontal
			...
			glPushMatrix();
				...
				figura.prisma(1.0, 1.0, 1.0, Barra.GLindex);
			glPopMatrix();
		glPopMatrix();
...
void pantalla()
{
	glPushMatrix();
		glPushMatrix();//pantalla
			...
			figura.prisma(1.0, 1.0, 1.0, Pret.GLindex);
		glPopMatrix();
		//patas
		glPushMatrix();//Tronco
		...
		glPushMatrix();//Base
			...
			glPushMatrix();
				figura.cilindro(1.3, 0.1, 15, Pret.GLindex);
			glPopMatrix();
		glPopMatrix();
		glPushMatrix();//Pantalla
...
void bocina()
{
	glPushMatrix();//Estructura 
		...
		glPushMatrix();//Mueble pantalla
		glScalef(4.5, 5.0, 3.0);
		glTranslatef(1.1, 0, 0);
		figura.prisma(1.0, 1.0, 1.0, Marco.GLindex);
		glPopMatrix();

		glPushMatrix();
		glScalef(3.0, 5.0, 3.0);//Mueble lampara
		glTranslatef(3.5, 0, 0);
		figura.prisma(1.0, 1.0, 1.0, Madera2.GLindex);
		glPopMatrix();

		glPushMatrix();
		glScalef(0.5, 4.0, 0.5);//Tronco lampara
		glTranslatef(21.0, 1.0, 0.25);
		figura.prisma(1.0, 1.0, 1.0, Pret.GLindex);
		glPopMatrix();

		glPushMatrix();
		glScalef(1.0, 2.0, 1.0);//lampara
		glTranslatef(10.5, 3.5, 0);
		figura.prisma(1.0, 1.0, 1.0, Metal.GLindex);
		glPopMatrix();

		glPushMatrix();
		//glScalef(1.0, 2.0, 1.0);//Base lampara
		glTranslatef(10.5, 2.5, 0);
		figura.cilindro(0.8, 0.1, 15.0, Pret.GLindex);
		glPopMatrix();
		...
		glPushMatrix();//Bocina grande
			...
			glPushMatrix();
				figura.cilindro(0.8, 0.1, 20, Pret.GLindex);
			glPopMatrix();
		glPopMatrix();
		...
		glPushMatrix();		
			...
			glPushMatrix();//lado izquierdo
				...
				glPushMatrix();
					...
					figura.prisma(1.0, 1.0, 1.0, ParedBlan.GLindex);
				glPopMatrix();
				glPushMatrix();//puerta
				...
				glTranslatef(65.0, -35.0, -20.0);
				glPushMatrix();
				glScalef(20.0, 1.0, 10.0);
				figura.prisma(1.0, 1.0, 1.0, Alfombra.GLindex);
				glPopMatrix();
				glPopMatrix();
